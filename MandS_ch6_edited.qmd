...
### Problem 10
Find the derivative of $f(x)=e^{g(x)} \text{ where } g(x)=7+5x-3x^2 + \ln(x) -7$


### Problem 11
Find the derivative of $f(x)=x^2g(x)+6x^2 \text{ where }g(x)=\log_{\alpha}(x^7)$


### Problem 12
Find the derivative of $f(x)=ax^2g(x)+9x^4 \text{ where }g(x)=e^{\ln(x)+2x^2}$
